      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <h6 class="card-subtitle mb-1 fw-bold">Hoa hồng giới thiệu mặc định (%)</h6>
            <p class="card-text" id="referral_commission_default"></p>
          </div>
        </div>
            ...
            <form id="general_s_form">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    <label class="form-label fw-bold">Hoa hồng giới thiệu mặc định (%)</label>
                    <input type="number" name="referral_commission_default" id="referral_commission_default_inp" min="0" max="100" step="0.1" class="form-control shadow-none" required>
                  </div>
                </div>
                <div class="modal-footer">
                  <button type="button" onclick="site_title.value = general_data.site_title, site_about.value = general_data.site_about, referral_commission_default_inp.value = general_data.referral_commission_default" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Huỷ</button>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="mb-4">
                  <h6 class="card-subtitle mb-1 fw-bold">Khung nội tuyến</h6>
                  ...
                  <div class="container-fluid p-0">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          <label class="form-label fw-bold">Khung nội tuyến Src</label>
